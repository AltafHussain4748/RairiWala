...
public class OrderDetailGoogleMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
                        ...
                        .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                            ...
                            public void onSuccess(Location location) {
                                ...
                                if (location != null) {
                                    ...
                                    mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in meri locationy"));
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(orderLocation, 17));
    }
